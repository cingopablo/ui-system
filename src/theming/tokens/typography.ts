...
export const text = {
  ...
  large: { fontSize: 'var(--font-size-4)', fontWeight: 'var(--font-weight-2)', lineHeight: 'var(--font-height-text)' },
  medium: { fontSize: 'var(--font-size-3)', fontWeight: 'var(--font-weight-2)', lineHeight: 'var(--font-height-text)' },
  button: { fontSize: 'var(--font-size-2)', fontWeight: 'var(--font-weight-3)', lineHeight: 'var(--font-height-text)' },
  default: {
